...
HeaderVideo.prototype.appendIframe = function() {
	...
	this.$element.find('.header-video-content').fadeOut();
	this.$element.find('.header-video-overlay').fadeOut();
	this.$element.find('#menu').fadeOut();
};
...
HeaderVideo.prototype.removeIframe = function() {
	...
	this.$element.find('.header-video-content').fadeIn();
	this.$element.find('.header-video-overlay').fadeIn();
	this.$element.find('#menu').fadeIn();
};
