...
//    });
    ...
    if($("#site_lockdown_allowed_pages").length){
        $("#site_lockdown_allowed_pages").select2({
          ajax: {
    ...
    if($("#site_lockdown_allowed_posts").length){
        $("#site_lockdown_allowed_posts").select2({
          ajax: {
            url: UPMEAdmin.AdminAjax,
            dataType: 'json',
            delay: 250,
    ...
    if($("#site_lockdown_redirect_url").length){
        $("#site_lockdown_redirect_url").select2({
          ajax: {
            url: UPMEAdmin.AdminAjax,
            dataType: 'json',
            delay: 250,
    ...
    if($("#site_content_redirect_url").length){
        $("#site_content_redirect_url").select2({
          ajax: {
            url: UPMEAdmin.AdminAjax,
            dataType: 'json',
            delay: 250,
    ...
    if($("#site_content_page_restrictions").length){
        $("#site_content_page_restrictions").select2({
          ajax: {
            url: UPMEAdmin.AdminAjax,
            dataType: 'json',
            delay: 250,
    ...
    if($("#site_content_post_restrictions").length){
        $("#site_content_post_restrictions").select2({
          ajax: {
            url: UPMEAdmin.AdminAjax,
            dataType: 'json',
            delay: 250,
