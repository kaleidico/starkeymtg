...
function siuf_insert() {
	...
	echo("(function() {function socialintents(){\n");
        ...
        echo("    var s = document.createElement('script');s.type = 'text/javascript';s.async = true;s.src = siJsHost+'www.socialintents.com/api/feedback/socialintents.js#".get_option('siuf_widgetID')."';\n");
...
http://www.socialintents.com/" title="', '">', '</a>') ?></p>
		...
		<input type="hidden" name="action" value="update" />
                <input type="hidden" name="page_options" value="siuf_rounded_corners, siuf_popup_width, siuf_popup_height, siuf_tab_text,siuf_tab_placement,siuf_header_text,siuf_intro_text,siuf_rating_text,siuf_feedback_text,siuf_time_on_page,siuf_tab_color" />
		<table width="100%" >
...
<tr><td>Popup Height: </td>
		...
		<?php 
   		...
   		?>
		<input type="text" name="siuf_popup_height" id="siuf_popup_height" value="380px" style="margin:3px;width:100%;" placeholder="Height in Pixels - 150px"/>
		<?php 
			}
   		?>
		</td></tr>
